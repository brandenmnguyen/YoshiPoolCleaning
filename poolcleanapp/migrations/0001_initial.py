# Generated by Django 5.0.3 on 2024-04-27 23:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appstatus', models.CharField(choices=[('n', 'In progress'), ('y', 'Completed')], default='n', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='poolcleanapp.company')),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='poolcleanapp.client')),
            ],
            options={
                'db_table': 'INVOICE',
                'managed': True,
